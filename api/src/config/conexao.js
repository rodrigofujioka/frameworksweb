...
const agendamento = {nome:'Rodrigo Fujioka', email: 'fujifuji@uol.com.br', ativo:0 }
...
con.query('UPDATE agendamento SET nome = ?, email = ? where ID = ? ', ['Dayvison','fu@uol','1'], (err,rows) => {
    if(err) throw err
